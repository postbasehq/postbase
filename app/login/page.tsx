            ...
            <>
              ...
              <div className="mt-6 flex flex-col gap-2.5">
                <button
                  ...
                  className="flex items-center justify-center gap-2.5 rounded-full border border-line bg-surface px-5 py-2.5 text-sm font-semibold transition hover:bg-surface-2 disabled:opacity-60"
                >
                  <GoogleIcon />
