...
export const PLANS: Record<Exclude<PlanId, "trial">, Plan> = {
  creator: {
    ...
    features: ["5 channels", "Unlimited posts", "All platforms (X = BYOK)", "MCP server", "Threads, media & calendar"],
  ...
  team: {
    ...
    features: ["15 channels", "Team seats", "Analytics", "Bulk & video scheduling", "Everything in Creator"],
